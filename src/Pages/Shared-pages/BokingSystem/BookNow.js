                    ...
                    <div>
                        ...
                        {/* User Name sector */}
                            <div className="form-control w-full max-w-xs">
                                ...
                                <input type="text" name='name' value="" placeholder="Your Name" className="input input-bordered w-full max-w-xs" readOnly disabled/>
                        ...
                        {/* Booking items Name */}
                            <div className="form-control w-full max-w-xs">
                                ...
                                <input type="text" name='item' value="" placeholder="Type here" className="input input-bordered w-full max-w-xs" readOnly disabled/>
                        ...
                        {/* Product Price */}
                            <div className="form-control w-full max-w-xs">
                                ...
                                <input type="text" name='price' value="" placeholder="Type here" className="input input-bordered w-full max-w-xs" readOnly disabled/>
