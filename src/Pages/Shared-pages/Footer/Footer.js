        ...
        <div>
            <footer className="footer p-10 bg-sky-200 text-base-content">
                <nav>
                    ...
                    <a className="link text-base link-hover">Branding</a>
                    <a className="link text-base link-hover">Design</a>
                    <a className="link text-base link-hover">Marketing</a>
                    <a className="link text-base link-hover">Advertisement</a>
                </nav>
                <nav>
                    <h6 className="footer-title">Company</h6>
                    <a className="link text-base link-hover">About us</a>
                    <Link to={"/contact"} className="text-base hover:text-">Contact</Link>
                    <a className="link text-base link-hover">Jobs</a>
                    <a className="link text-base link-hover">Press kit</a>
                </nav>
                <nav>
                    <h6 className="footer-title">Legal</h6>
                    <a className="link text-base link-hover">Terms of use</a>
                    <a className="link text-base link-hover">Privacy policy</a>
                    <a className="link text-base link-hover">Cookie policy</a>
                </nav>
            </footer>
